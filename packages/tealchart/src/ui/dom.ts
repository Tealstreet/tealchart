...
export const icons = {
  ...
  /** Drawing object tree / list icon */
  objectTree: (size = 16, color = 'currentColor'): SVGElement => svg('svg', {
    width: String(size),
    height: String(size),
    viewBox: '0 0 24 24',
    fill: 'none',
    ...
    svg('line', { x1: '9', y1: '12', x2: '20', y2: '12' }),
    svg('line', { x1: '9', y1: '18', x2: '20', y2: '18' }),
    svg('circle', { cx: '4.5', cy: '6', r: '1.4' }),
    svg('circle', { cx: '4.5', cy: '12', r: '1.4' }),
    svg('circle', { cx: '4.5', cy: '18', r: '1.4' }),
  ]),
