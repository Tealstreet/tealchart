...
describe('user drawing editing', () => {
  ...
  it('moves icons by dragging the center handle', () => {
    const drawing: UserDrawing = {
      ...base,
      id: 'icon',
      kind: 'icon',
    ...
    const state = createUserDrawingState({
      drawings: [drawing],
      selection: { drawingId: 'icon', handle: 'center' },
    });
  ...
  it('moves balloons by dragging the center handle', () => {
    ...
    const state = createUserDrawingState({
      drawings: [drawing],
      selection: { drawingId: 'balloon', handle: 'center' },
    });
  ...
  it('moves emojis by dragging the center handle', () => {
    const drawing: UserDrawing = {
      ...base,
      id: 'emoji',
      kind: 'emoji',
    ...
    const state = createUserDrawingState({
      drawings: [drawing],
      selection: { drawingId: 'emoji', handle: 'center' },
    });
  ...
  it('moves and edits cypher pattern anchors with stable five-point shape', () => {
    const drawing: UserDrawing = {
      ...base,
      id: 'cypher',
      kind: 'cypherPattern',
    ...
    const edited = applyUserDrawingEditDrag(
      state,
      {
        selection: { drawingId: 'cypher', handle: 'center', pointIndex: 3 },
        startPoint: { x: 40, y: 40 },
        startDrawing: drawing,
        space,
      },
  ...
  it('moves and edits Elliott corrective wave anchors with stable three-point shape', () => {
    const drawing: UserDrawing = {
      ...base,
    ...
    const edited = applyUserDrawingEditDrag(
      state,
      {
        selection: { drawingId: 'elliott-corrective', handle: 'center', pointIndex: 2 },
  ...
  it('moves and edits Elliott triple combo wave anchors with stable five-point shape', () => {
    const drawing: UserDrawing = {
      ...base,
    ...
    const edited = applyUserDrawingEditDrag(
      state,
      {
        selection: { drawingId: 'elliott-triple-combo', handle: 'center', pointIndex: 4 },
        startPoint: { x: 90, y: 55 },
        startDrawing: drawing,
        space,
      },
