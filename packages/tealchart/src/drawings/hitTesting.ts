...
function hitTestResolvedGeometry(
  ...
  if (
    ...
    geometry.kind === 'elliottDoubleComboWave' ||
    geometry.kind === 'elliottTripleComboWave' ||
    geometry.kind === 'elliottTriangleWave'
  ) {
  ...
  if (geometry.kind === 'gannBox' || geometry.kind === 'gannSquare' || geometry.kind === 'gannSquareFixed') {
...
function hitTestUserDrawingHandle(
  ...
  switch (geometry.kind) {
    ...
    case 'datePriceRange':
      {
        const rect =
          geometry.kind === 'gannBox' || geometry.kind === 'gannSquare' || geometry.kind === 'gannSquareFixed'
