...
const TEALSTREET_INDICATORS: BuiltinIndicator[] = [
  ...
  },
  {
    ...
    jailbreak: {
      inputs: [
        ...
        { id: 'pocLineWidth', name: 'POC Line Width', type: 'int', defval: 2, min: 1, max: 5, step: 1 },
        ...
        { id: 'vahValLineWidth', name: 'VAH/VAL Line Width', type: 'int', defval: 1, min: 1, max: 5, step: 1 },
  ...
  },
  {
    ...
    category: 'tealstreet',
    description: 'Zones of consecutive diagonal bid/ask imbalances from the real order-flow feed',
    overlay: true,
    code: '',
    jailbreak: {
      inputs: [
        { id: 'imbalanceRatio', name: 'Imbalance Ratio', type: 'float', defval: 3, min: 1.1, max: 20, step: 0.1 },
        { id: 'consecutiveLevels', name: 'Consecutive Levels', type: 'int', defval: 3, min: 2, max: 10, step: 1 },
        { id: 'minVolume', name: 'Min Volume (0 = off)', type: 'float', defval: 0, min: 0, max: 1000000, step: 1 },
        { id: 'lookbackBars', name: 'Lookback Bars', type: 'int', defval: 500, min: 10, max: 2000, step: 10 },
        { id: 'maxTouches', name: 'Max Touches', type: 'int', defval: 1, min: 1, max: 10, step: 1 },
        {
          id: 'lineStyle',
          name: 'Line Style',
          type: 'string',
        ...
        { id: 'lineWidth', name: 'Line Width', type: 'int', defval: 1, min: 0, max: 5, step: 1 },
        { id: 'opacity', name: 'Zone Opacity', type: 'float', defval: 0.25, min: 0.02, max: 1, step: 0.01 },
        { id: 'showVolumeLabels', name: 'Show Volume Labels', type: 'bool', defval: true },
      ...
      palette: {
        buyStack: { name: 'Buy Stack', defaultColor: 'rgba(38, 166, 154, 1)' },
        sellStack: { name: 'Sell Stack', defaultColor: 'rgba(239, 83, 80, 1)' },
        brokenZone: { name: 'Broken Zone', defaultColor: 'rgba(128, 128, 128, 0.8)' },
        text: { name: 'Text Color', defaultColor: 'rgba(255, 255, 255, 0.55)' },
      },
    },
  },
  {
    ...
    name: 'Absorption',
    category: 'tealstreet',
    description: 'Levels where aggressive volume from the order-flow feed failed to move price',
    overlay: true,
    code: '',
    jailbreak: {
      inputs: [
        {
          id: 'minCandleSizeTicks',
          name: 'Min Candle Size (ticks)',
          type: 'int',
          defval: 2,
          min: 0,
          max: 1000,
        ...
        {
          id: 'minDeltaThreshold',
          name: 'Min Row Delta (0 = auto)',
          type: 'float',
          defval: 0,
          min: 0,
          max: 10000000,
        ...
        { id: 'priceMovePercent', name: 'Price Move %', type: 'float', defval: 0.15, min: 0.01, max: 10, step: 0.01 },
        {
          id: 'priceMoveTimeSeconds',
          name: 'Price Move Window (s)',
          type: 'int',
          defval: 60,
          min: 1,
          max: 86400,
        ...
        },
        {
          ...
          type: 'string',
          defval: 'everywhere',
          options: ['everywhere', 'body', 'shadow'],
        },
        { id: 'tickSlippage', name: 'Tick Slippage', type: 'int', defval: 1, min: 0, max: 100, step: 1 },
        {
          id: 'requireOppositeCandleDelta',
          name: 'Require Opposite Candle Delta',
          type: 'bool',
          defval: false,
        },
        { id: 'requireCloseDirection', name: 'Require Close Direction', type: 'bool', defval: false },
        { id: 'showLines', name: 'Show Level Lines', type: 'bool', defval: true },
        {
          id: 'markerShape',
          name: 'Marker Shape',
          type: 'string',
        ...
        { id: 'markerSize', name: 'Marker Size', type: 'int', defval: 5, min: 2, max: 20, step: 1 },
        { id: 'lookbackBars', name: 'Lookback Bars', type: 'int', defval: 500, min: 10, max: 2000, step: 10 },
        { id: 'rowSizeMode', name: 'Row Size Mode', type: 'string', defval: 'Auto', options: ['Auto', 'Ticks'] },
        { id: 'rowSizeTicks', name: 'Row Size (ticks)', type: 'int', defval: 1, min: 1, max: 500, step: 1 },
      ],
      defaults: {
        ...
        minDeltaThreshold: 0,
        priceMovePercent: 0.15,
        priceMoveTimeSeconds: 60,
        searchLocation: 'everywhere',
        tickSlippage: 1,
        requireOppositeCandleDelta: false,
        requireCloseDirection: false,
        showLines: true,
        markerShape: 'circle',
        markerSize: 5,
        lookbackBars: 500,
      ...
      palette: {
        ...
        sellAbsorption: { name: 'Absorbed Selling (bullish)', defaultColor: 'rgba(38, 166, 154, 1)' },
        line: { name: 'Level Line', defaultColor: 'rgba(255, 255, 255, 0.35)' },
        text: { name: 'Text Color', defaultColor: 'rgba(255, 255, 255, 0.55)' },
      },
    },
  },
