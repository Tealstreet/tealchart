export const PINE_V6_REFERENCE_MANUAL_INDEX_SOURCE = {
  page: 'https://www.tradingview.com/pine-script-reference/v6/',
  bundle: 'https://static.tradingview.com/static/bundles/34575.65936afe5d868ef48f65.js',
  retrievedAt: '2026-08-30',
  notes: 'Names-only snapshot extracted from the official TradingView Pine Script v6 reference manual index.',
} as const;

export const PINE_V6_REFERENCE_MANUAL_BUILTIN_INDEX = {
  functions: [
    'alert',
    'alertcondition',
    'array.abs',
...
export const PINE_V6_REFERENCE_MANUAL_GRAMMAR_INDEX = {
  keywords: [
    'and',
    'as',
    'break',
