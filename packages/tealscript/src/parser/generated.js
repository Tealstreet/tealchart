...
function peg$parse(input, options) {
  ...
  const peg$c62 = "r";
  const peg$c63 = "t";
  const peg$c64 = "strategy";
  const peg$c65 = "library";
  const peg$c66 = "import";
  const peg$c67 = "export";
  const peg$c68 = "//";
  const peg$c69 = "/*";
  const peg$c70 = "*/";
  ...
  const peg$e44 = peg$literalExpectation("switch", false);
  const peg$e45 = peg$literalExpectation("?", false);
  const peg$e46 = peg$literalExpectation(":", false);
  const peg$e47 = peg$literalExpectation("or", false);
  ...
  const peg$e56 = peg$literalExpectation("not", false);
  const peg$e57 = peg$literalExpectation("na", false);
  ...
  const peg$e69 = peg$literalExpectation("r", false);
  const peg$e70 = peg$literalExpectation("t", false);
  const peg$e71 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e72 = peg$classExpectation(["e", "E"], false, false, false);
  ...
  const peg$e75 = peg$literalExpectation("strategy", false);
  const peg$e76 = peg$literalExpectation("library", false);
  const peg$e77 = peg$literalExpectation("import", false);
  const peg$e78 = peg$literalExpectation("export", false);
  ...
  function peg$f49(discriminant, cases) {
    return {
  ...
  function peg$f51(test, consequent) {
    return {
      type: 'SwitchCase',
      test,
      consequent,
  ...
  function peg$f55() {    return "or";  }
  function peg$f56() {    return "and";  }
  ...
  function peg$f61() {    return "not";  }
  function peg$f62(head, args) {    return { type: 'call', args: args || [] };  }
  function peg$f63(head, prop) {    return { type: 'member', prop };  }
  function peg$f64(head, index) {    return { type: 'index', index };  }
