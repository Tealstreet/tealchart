...
badCloseBarsHigh = time_close("60", bars_back=5001)
badCloseBarsLow = time_close("60", bars_back=-501)
badCloseBarsFloat = time_close("60", bars_back=1.5)
badCloseTfHigh = time_close("60", timeframe_bars_back=5001)
badCloseTfLow = time_close("60", timeframe_bars_back=-501)
badCloseTfFloat = time_close("60", timeframe_bars_back=1.5)
...
`));
    ...
    expect(result.diagnostics.map((diagnostic) => diagnostic.message)).toEqual([
      ...
      'time timeframe_bars_back must be an integer between -500 and 5000',
      'time timeframe_bars_back must be an integer between -500 and 5000',
      'time_close bars_back must be an integer between -500 and 5000',
      'time_close bars_back must be an integer between -500 and 5000',
      'time_close bars_back must be an integer between -500 and 5000',
      'time_close timeframe_bars_back must be an integer between -500 and 5000',
      'time_close timeframe_bars_back must be an integer between -500 and 5000',
      'time_close timeframe_bars_back must be an integer between -500 and 5000',
