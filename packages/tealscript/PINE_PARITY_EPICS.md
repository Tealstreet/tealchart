...
- Compatibility fixtures for real Pine idioms including MTF filters,
  ...
  custom candles, drawing zones, multi-symbol screeners, imported library
  helpers, alerts, request-limit reuse, strategy entry/exit flows, default
  broker-emulator path and gap-fill behavior, and common drawing/table patterns.
