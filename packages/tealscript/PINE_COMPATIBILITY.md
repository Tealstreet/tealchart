...
selective immediate closes, fill-alert suppression, entry-direction risk rules,
and recalculation checkpoints.
...
- Known built-in calls report clear diagnostics for unknown named arguments,
  ...
  strict signatures. Worker wrapper coverage preserves structured semantic
