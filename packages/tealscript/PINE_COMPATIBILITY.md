...
`ta.rsi()`, `ta.hma()`, and cross helpers preserve per-call previous values for
derived source expressions. These are covered in the golden compatibility harness. `ta.rma()`
