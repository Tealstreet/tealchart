...
| Public-script layout shapes | `Public UDT State Layout Checkpoint`; `Public Loop Header Layout Checkpoint`; parser layout fixtures in `parser.test.ts` | `pine-real-checkpoints.test.ts`; `parser.test.ts` |
