...
| Marker output payloads | `Official Marker Payload Checkpoint`; `Public Marker Signal Checkpoint`; `Public Earnings Event Checkpoint`; `Public Corporate Actions Checkpoint`; marker color/text payload fixtures in `pine-visuals.test.ts` | `pine-real-checkpoints.test.ts`; `pine-visuals.test.ts` |
