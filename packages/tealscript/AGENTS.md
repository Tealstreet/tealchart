# packages/tealscript Agent Guide

## Scope

This file applies to work under `packages/tealscript`.

## Workspace Role

- Workspace package `@tealstreet/tealscript`.
- Main implementation is under `src/`.
- Referenced by 1 internal workspace.

## Commands (run from `packages/tealscript`)
