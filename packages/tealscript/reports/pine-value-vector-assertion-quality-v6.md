...
# Pine Value Vector Assertion Quality V6

## Basis

- Source: `packages/tealscript/scripts/run-pine-value-vectors.ts` at current HEAD.
- Member denominator: the 811 official names already covered by at least one vector case in `pine-value-vector-member-map-v27`.
