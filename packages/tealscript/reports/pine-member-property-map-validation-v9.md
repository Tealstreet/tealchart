# Pine Member Property Map Validation V9

> Superseded by `pine-member-property-map-validation-v10.md`. Historical measurement only.
...
- Passing vector cases checked: 814/817.
- Evaluated rule applications: 1175.
- Unique applied member/kind rules: 770.
