# Pine Member Property Validation Filter V14

## Headline

- Property rules: 992.
- Scalar/proxy/tuple/collection rules eligible for the current validator: 837.
...
- Scalar/proxy/tuple/collection rules attributable to single-target passing cases: 124.
...
- Scalar/proxy/tuple/collection rules unlocked by constructed single-target cases: 185.
- Scalar/proxy/tuple/collection rules still stranded behind judgment cases: 1.
- Combined known-good validation coverage after shipped studies: 897/992 (90.42%).
...
- single-target passing cases: 251
- multi-target passing cases: 139
- zero-target passing cases: 541
...
- Constructed single-target sample unlocked 185 rules.
...
- `drawing.delete-all-values`: 4 outputs, 0 scalar/tuple rules
- `drawing.box-style-text-values`: 9 outputs, 6 scalar/tuple rules
- `drawing.table-payload-values`: 1 outputs, 0 scalar/tuple rules
- `drawing.table-cell-setter-clear-values`: 1 outputs, 0 scalar/tuple rules
- `drawing.polyline-payload-values`: 1 outputs, 0 scalar/tuple rules
...
- `request.security-lower-tf-array-values`: 4 outputs, 0 scalar/tuple rules
...
- `property.single.math.e`: 1 output, 1 scalar/tuple/collection rules
- `property.single.math.exp`: 1 output, 2 scalar/tuple/collection rules
- `property.single.math.phi`: 1 output, 1 scalar/tuple/collection rules
- `property.single.math.pi`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.format`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.format_time`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.lower`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.match`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.repeat`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.replace`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.replace_all`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.substring`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.trim`: 1 output, 1 scalar/tuple/collection rules
- `property.single.str.upper`: 1 output, 1 scalar/tuple/collection rules
...
- `property.single.strategy.closedtrades.entry_id`: 1 output, 2 scalar/tuple/collection rules
- `property.single.strategy.closedtrades.entry_comment`: 1 output, 2 scalar/tuple/collection rules
- `property.single.strategy.closedtrades.exit_id`: 1 output, 2 scalar/tuple/collection rules
- `property.single.strategy.closedtrades.exit_comment`: 1 output, 2 scalar/tuple/collection rules
- `property.single.line.copy`: 1 output, 0 scalar/tuple/collection rules
- `property.single.box.copy`: 1 output, 0 scalar/tuple/collection rules
- `property.single.label.copy`: 1 output, 0 scalar/tuple/collection rules
- `property.single.chart.point.from_index`: 1 output, 0 scalar/tuple/collection rules
- `property.single.chart.point.from_time`: 1 output, 0 scalar/tuple/collection rules
- `property.single.chart.point.new`: 1 output, 0 scalar/tuple/collection rules
- `property.single.chart.point.now`: 1 output, 0 scalar/tuple/collection rules
- `property.single.chart.point.copy`: 1 output, 0 scalar/tuple/collection rules
