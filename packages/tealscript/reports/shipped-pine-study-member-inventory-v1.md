> Superseded by shipped-pine-study-member-inventory-v2.md. Historical measurement only; use the superseding report for current figures.

# Shipped Pine Study Member Inventory V1

## Basis

- Measurement SHA: `d568863928`.
