...
# External Pine Corpus v5 Fixture Profile Delta v1
...
- Daily report: `/Users/samuelsteady/cs/tealstreet-next/.aimux/worktrees/tealscript-parity/packages/tealscript/.cache/tealscript/pine-corpus-v5-20260910/fixture-profiles/external-pine-corpus-v5-daily-standard.json`.
- Context-stress report: `/Users/samuelsteady/cs/tealstreet-next/.aimux/worktrees/tealscript-parity/packages/tealscript/.cache/tealscript/pine-corpus-v5-20260910/fixture-profiles/external-pine-corpus-v5-context-stress.json`.
- Daily bars: 1600, 1,600 volatile weekday daily bars, sha256 73a22074c6f110dd.
- Context-stress bars: 5200, 5,200 mixed intraday/session and 24/7 bars across multi-year history, sha256 fd783180c2edc591.
...
- Daily profile: 838/1000 raw output (83.8%); 838/925 achievable output (90.59%); validity {"corpus-hygiene":8,"invalid-pine":57,"supported":843,"tealscript-gap":82,"unsupported-by-design":10}.
- Context-stress profile: 835/1000 raw output (83.5%); 835/925 achievable output (90.27%); validity {"corpus-hygiene":8,"invalid-pine":57,"supported":842,"tealscript-gap":83,"unsupported-by-design":10}.
- Rows with changed payload or classification: 144/1000.
- Rows improving to supported output: 0.
- Rows regressing from supported output: 3.

## Changed Rows By Validity

| Transition | Rows |
| --- | ---: |
| supported -> supported | 142 |
...
| `sources/0505__casoon-pine-scripts__coilforge_zones_v1.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, volume_dependent |
| `sources/0506__casoon-pine-scripts__edge_atlas.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, timeframe_identity, volume_dependent, request_timeframes, symbol_metadata, tick_precision_contract, higher_timeframe_literals, intraday_clock_calendar, session_windows |
...
| `sources/0509__casoon-pine-scripts__liquidity_hunter.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, timeframe_identity, volume_dependent, tick_precision_contract, explicit_long_history, session_windows |
...
| `sources/0511__casoon-pine-scripts__market_scenario_projector.pine` | supported \| pass \| produced-output-compiled | supported \| output \| no-output-compiled \| output-silence:synthetic-window-did-not-trigger-output: The default 160-bar synthetic window did not trigger visible output, but the extende | drawing_objects_limits, barstate_realtime_or_lastbar, timeframe_identity, symbol_metadata, explicit_long_history, intraday_clock_calendar |
...
| `sources/0522__casoon-pine-scripts__support_resistance_zones.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, volume_dependent, explicit_long_history |
...
| `sources/0530__casoon-pine-scripts__zigzag_fibo_pullback_map.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, explicit_long_history |
...
| `sources/0533__casoon-pine-scripts__midas_curves.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, timeframe_identity, volume_dependent, higher_timeframe_literals |
...
| `sources/0543__casoon-pine-scripts__momentum_profile.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | drawing_objects_limits, barstate_realtime_or_lastbar, volume_dependent, tick_precision_contract, explicit_long_history |
