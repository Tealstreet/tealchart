> Superseded by pine-member-property-map-validation-v14.md. Historical measurement only; use the superseding report for current figures.

# Pine Member Property Map Validation V13
...
- Property rules in map: 992.
- Passing vector cases checked: 968/981.
- Evaluated rule applications: 1546.
- Unique applied member/kind rules: 879.
