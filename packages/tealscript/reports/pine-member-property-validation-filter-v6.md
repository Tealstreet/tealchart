Superseded by `pine-member-property-validation-filter-v7.md`. Historical measurement only.

# Pine Member Property Validation Filter V6
...
- Rules on vector-covered members: 944; scalar/proxy/tuple/collection subset: 793.
- Scalar/proxy/tuple/collection rules reachable by passing vector targets: 793.
- Scalar/proxy/tuple/collection rules attributable to single-target passing cases: 114.
- Scalar/proxy/tuple/collection rules present only in multi-target passing cases: 682.
- Scalar/proxy/tuple/collection rules unlocked by output-to-member annotations: 487.
- Scalar/proxy/tuple/collection rules still stranded behind judgment cases: 195.
- Combined known-good validation coverage after shipped studies: 691/993 (69.59%).
...
- Rules unlocked by mechanical annotations, scalar proxy validation, and collection attribution: 487.
