# Pine Member Property Map Validation V10

> Superseded by `pine-member-property-map-validation-v11.md`. Historical measurement only.
...
- Passing vector cases checked: 839/842.
- Evaluated rule applications: 1200.
- Unique applied member/kind rules: 795.
