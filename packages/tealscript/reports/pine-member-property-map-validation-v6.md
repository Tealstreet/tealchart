Superseded by `pine-member-property-map-validation-v7.md`. Historical measurement only.

# Pine Member Property Map Validation V6
...
- Evaluated rule applications: 1018.
- Unique applied member/kind rules: 686.
