# Pine Value Vector Assertion Quality V9

> Superseded by `pine-value-vector-assertion-quality-v10.md`. Historical measurement only.

## Basis

- Source: `packages/tealscript/scripts/run-pine-value-vectors.ts` at current HEAD.
- Member denominator: the 811 official names already covered by at least one vector case in `pine-value-vector-member-map-v30`.
...
- Covered official members: 813.
- Value-checked: 785/813 (96.56%).
- Property-checked only: 23/813 (2.83%).
- Ran-only: 5/813 (0.62%).
