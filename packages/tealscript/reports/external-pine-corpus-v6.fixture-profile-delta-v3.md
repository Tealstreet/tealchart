# External Pine Corpus V6 Fixture Profile Delta v3
...
- Daily report: `/Users/samuelsteady/cs/tealstreet-next/.aimux/worktrees/tealscript-parity/packages/tealscript/reports/external-pine-corpus-v6.fixture-profile-delta-v3-runs/external-pine-corpus-v6-daily-standard.json`.
- Context-stress report: `/Users/samuelsteady/cs/tealstreet-next/.aimux/worktrees/tealscript-parity/packages/tealscript/reports/external-pine-corpus-v6.fixture-profile-delta-v3-runs/external-pine-corpus-v6-context-stress.json`.
...
- Daily profile: 781/1000 raw output (78.1%); 781/934 achievable output (83.62%); validity {"invalid-pine":26,"supported":794,"tealscript-gap":140,"unsupported-by-design":40}.
- Context-stress profile: 786/1000 raw output (78.6%); 786/934 achievable output (84.15%); validity {"invalid-pine":26,"supported":797,"tealscript-gap":137,"unsupported-by-design":40}.
- Rows with changed payload or classification: 91/1000.
...
| `sources/0382__helenananaa-pine-compat-runtime__user_methods.pine` | supported \| pass \| produced-output-compiled | supported \| pass \| produced-output-compiled | none scanned |
