# Pine Member Property Map Validation V11

> Superseded by `pine-member-property-map-validation-v12.md`. Historical measurement only.
...
- Passing vector cases checked: 847/850.
- Evaluated rule applications: 1226.
- Unique applied member/kind rules: 821.
