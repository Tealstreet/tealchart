> Superseded by `pine-value-vector-oracle-source-provenance-v6.md`. Historical measurement only.

# Pine Value Vector Oracle Source Provenance V5

Measurement commit: `71cea1e770`.

## Finding

Value-vector expectations remain independent of the committed reference
snapshot after the property-lens validation expansion.
...
- `656` rule strings gained citations before v4; `0` expected values, payloads
  or diagnostics changed in this v5 refresh.
...
- Snapshot corruption still has narrow value-oracle blast radius: `0/976`
