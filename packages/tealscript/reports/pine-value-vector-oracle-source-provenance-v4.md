> Superseded by `pine-value-vector-oracle-source-provenance-v5.md`. Historical measurement only.

# Pine Value Vector Oracle Source Provenance V4
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Passing cases | `949` | `1` | `0` | `0` | `0` |
| All cases | `962` | `1` | `0` | `0` | `0` |
| Expected-red cases | `13` | `0` | `0` | `0` | `0` |
...
- The first pass found `121` reference-only high-risk cases by namespace:
  ...
  `matrix` `1`.
- The current guard requires wider concept pages for those surfaces; the v170
...
- Snapshot corruption still has narrow value-oracle blast radius: `0/950`
