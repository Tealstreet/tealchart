# Pine Value Vector Oracle Provenance V5

Superseded by `pine-value-vector-oracle-provenance-v6.md`. Historical measurement only.

## Basis

- Source: `packages/tealscript/scripts/run-pine-value-vectors.ts` at current HEAD.
- Input set: the 785 value-checked members from `pine-value-vector-assertion-quality-v5`.
