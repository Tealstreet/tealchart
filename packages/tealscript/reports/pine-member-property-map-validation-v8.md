# Pine Member Property Map Validation V8

> Superseded by `pine-member-property-map-validation-v9.md`. Historical measurement only.
...
- Passing vector cases checked: 795/799.
- Evaluated rule applications: 1155.
- Unique applied member/kind rules: 750.
