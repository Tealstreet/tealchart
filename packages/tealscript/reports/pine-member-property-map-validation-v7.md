# Pine Member Property Map Validation V7

> Superseded by `pine-member-property-map-validation-v8.md`. Historical measurement only.
...
- Passing vector cases checked: 749/752.
- Evaluated rule applications: 1108.
- Unique applied member/kind rules: 709.
