...
| Style controls | Shared descriptors/reducers/properties surface and quick selected-style commands exist | Top-bar, properties-surface, floating toolbar, and context command paths exist for quick stroke/fill style | Top-bar/handle, properties-surface, action strip, and context command paths exist for matching quick stroke/fill style | `partial` | Gap 4, Gap 6 polish |
| Floating selected toolbar | Shared selected-action surface and anchor model exist | Floating toolbar opens app-owned properties/object-tree UI, starts text edit for text drawings, and handles initial selected actions plus quick stroke/fill style | Anchored mobile action strip opens app-owned properties/object-tree UI, starts text edit for text drawings, and handles matching initial actions plus quick stroke/fill style | `partial` | Gap 4/5/6 polish |
| Drawing context menu | Shared context-action resolver exists | Drawing right-click menu opens app-owned properties/object-tree UI, starts text edit for text drawings, and handles initial actions plus quick stroke/fill style | Drawing long-press menu opens app-owned properties/object-tree UI, starts text edit for text drawings, and handles matching initial actions plus quick stroke/fill style | `partial` | Gap 4/5/6 polish |
