...
| Style controls | Shared descriptors/reducers/properties surface and quick selected-style commands exist | Top-bar, properties-surface, floating toolbar, and context command paths exist for quick stroke style | Top-bar/handle, properties-surface, action strip, and context command paths exist for matching quick stroke style | `partial` | Gap 4, Gap 6 polish |
| Floating selected toolbar | Shared selected-action surface and anchor model exist | Floating toolbar opens app-owned properties/object-tree UI and handles initial selected actions plus quick stroke style | Anchored mobile action strip opens app-owned properties/object-tree UI and handles matching initial actions plus quick stroke style | `partial` | Gap 4/5 polish |
| Drawing context menu | Shared context-action resolver exists | Drawing right-click menu opens app-owned properties/object-tree UI and handles initial actions plus quick stroke style | Drawing long-press menu opens app-owned properties/object-tree UI and handles matching initial actions plus quick stroke style | `partial` | Gap 4/5 polish |
