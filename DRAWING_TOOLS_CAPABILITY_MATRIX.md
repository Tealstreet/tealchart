...
| Floating selected toolbar | Shared selected-action surface and anchor model exist | Floating toolbar opens app-owned properties UI and handles initial selected actions plus quick stroke style | Anchored mobile action strip opens app-owned properties UI and handles matching initial actions plus quick stroke style | `partial` | Gap 4 polish |
| Drawing context menu | Shared context-action resolver exists | Drawing right-click menu opens app-owned properties UI and handles initial actions plus quick stroke style | Drawing long-press menu opens app-owned properties UI and handles matching initial actions plus quick stroke style | `partial` | Gap 4 polish |
