...
1. Add a lightweight manual or browser-level smoke harness for sidebar tool
   selection plus pointer drag, because the remaining risk is integration
   routing rather than state mutation.
